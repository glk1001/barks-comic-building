...
def fix_panels(in_file: str, out_file: str) -> None:
    ...
    bounding_box_processor = BoundingBoxProcessor(
        work_dir, COMIC_BUILDING_DIR, no_panel_expansion=True
    )
...
@app.command(help="Silent night panel restore (special case)")
def main(input_image_file: str, output_dir: str) -> None:
    global work_dir
