...
def shorten_volume_title(volume_title: str) -> str:
    ...
    They are long enough to wreck the table otherwise - "Carl Barks Vol. 9 - Donald Duck
    - The Pixilated Parrot (Digital-Empire)" becomes "Donald Duck - The Pixilated Parrot".
    The volume number is already its own column, and the release group is not what this
    report is about.
